...
### DISCLAIMER:
### This code is copied from PrediXcan repository at https://github.com/hakyimlab/PrediXcan
### The license of this source code is MIT license : Copyright (c) 2016 Hakymlab
### Because the current PrediXcan repository is deprecated, we keep a copy of the original software in SWAM repository
